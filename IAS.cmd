...
::
::   Homepages: https://github.com/Sabir555S
::              http://innocyber.free.nf/
::
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://github.com/Sabir555S/IDM-Activation-Script_555 & start %mas%/idm-activation-script & exit /b)
)
)
...
echo            =====================================================
echo:
call :_color2 %_White% "                              " %_Red% "INNO CYBER"
echo:
call :_color2 %_White% "                         " %_Cyan% "Version: %iasver%  -  Date: Dec 2025"
echo:
echo            =====================================================
echo:
...
echo:            ___________________________________________________
echo:
call :_color2 %_White% "                             " %_Yellow% "~ M.Sabir Ali ~"
echo:         
...
if %_erl%==6 exit /b
if %_erl%==5 start https://github.com/Sabir555S/IDM-Activation-Script_555 & start http://innocyber.free.nf/ & goto MainMenu
